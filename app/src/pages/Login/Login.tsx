      ...
      <div className={`modal-wrapper ${styles.login__wrapper}`}>
        <div className={styles.left}>
          ...
          <div className={`${styles.left__links}`}>
            <div className={`${styles.left__link} ${styles.right__link_border}`}>
          ...
          <Link to={'/recovery'} className={`text ${styles.login__link} ${styles.left__subtitle}`}>Забыл Пароль?</Link>
          <button type='submit' className={`${styles.left__button} button`}>Войти</button>
        </div>
        <div className={styles.right}>
          <p className={`${styles.right__title} title`}>Привет, друг!</p>
            <p className={`${styles.right__subtitle} text`}>Создай свой аккаунт, чтобы присоединиться к нам</p>
            <Link to={'/registration'} className={`button ${styles.right__button}`}>Зарегистрироваться</Link>
        </div>
      </div>
    </form>
    )

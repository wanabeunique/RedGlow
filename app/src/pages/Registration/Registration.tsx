...
export default function Registration() {
  ...
  return (
    <>
      <ToastContainer />
      <form
        className={`modal-wrapper ${styles.registration}`}
      ...
      >
        <div className={styles.registration__wrapper}>
          <div className={`${styles.registration__left} ${styles.left}`}>
            ...
            <p className={`text ${styles.left__subtitle}`}>
              Чтобы оставаться с нами, пожалуйста войдите в свой аккаунт.
            </p>
            <Link to="/login" className={`auth-button ${styles.left__button}`}>
              Войти
            </Link>
          </div>
          <div className={`${styles.registration__right} ${styles.right}`}>
            ...
            <div className={`${styles.right__links}`}>
              <div
                className={`${styles.right__link} ${styles.right__link_border}`}
              >
                <svg
              ...
              >
                ...
                >
                  <path
                    d="M13.1805 6.7487V4.9487H15V3.59926H13.1805V1.79926H11.817V3.59926H9.99825V4.9487H11.817V6.7487H13.1805ZM4.5465 1.75019C5.39766 1.75019 5.97085 2.11004 6.29689 2.41636L7.59053 1.17472C6.80323 0.446097 5.77628 2.05546e-07 4.5465 2.05546e-07C2.03886 -0.000743289 0 2.01561 0 4.49963C0 6.98364 2.03886 9 4.5465 9C7.17058 9 8.91271 7.17323 8.91271 4.60372C8.91271 4.22974 8.86463 3.96431 8.79777 3.68178H4.54425V5.35911H7.04738C6.92868 6.06617 6.28788 7.25948 4.5465 7.25948C3.04177 7.25948 1.81424 6.02156 1.81424 4.50558C1.81424 2.98736 3.04177 1.75019 4.5465 1.75019Z"
                    fill="black"
                  />
                </svg>
              </div>
            ...
            <ReCAPTCHA
              className={styles.registration__captcha}
            ...
            <button
              ...
              className={`${styles.registration__button} auth-button`}
            >
              Зарегистрироваться
            </button>
          </div>

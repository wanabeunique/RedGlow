...
import styles from './HeadbookCiv5Item.module.sass'
  // ! Уникальный юнит не всегда приходит с такими параметрами, исправить в будущем
export default function HeadbookCiv5Item({nation}) {
  ...
  return (
    <div className={`text ${styles.item}`}>
        ...
        nationUnit ? (
          nationUnit.map(el => (
            <div>
              ...
              <p className='text'>Замещает: {Object.values(el)[1]['Эпоха']}</p>

...
export default function Registration() {
  ...
  return (
    ...
    <div className={styles.registration__wrapper}>
      ...
      <input className={`${styles.registration__input} input`} type="text" />
      <p className={`${styles.registration__subtitle} subtitle`}>Пароль</p>
      <input className={`${styles.registration__input} input`} type="password" />
      ...
      <input className={`${styles.registration__input} input`} type="text" placeholder='+7 (___) ___ - __ - __'/>
      ...
      />
      <button type='submit' disabled={!isCaptchaSuccessful} className={`${styles.registration__button} button`}>Зарегистрироваться</button>
    </div>
  </form>
  )
}
